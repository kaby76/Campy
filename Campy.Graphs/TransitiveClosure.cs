...
namespace Campy.Graphs
{
     ...
     *    8:   T  T  T  T  T  T  T  T  T  T  T  T  T    <<<<<<<<<< KED NOTE: THIS IS WRONG!!!! 7 IS NOT REACHABLE FROM 8! THIS IS ANOTHER GRAPH, NOT THE ONE DESCRIBED!
...
";
            ...
            for (int v = 0; v < G.V; v++)
            {
                ...
                for (int w = 0; w < G.V; w++)
                {
                    if (tc.reachable(v, w)) System.Console.Write("  T");
